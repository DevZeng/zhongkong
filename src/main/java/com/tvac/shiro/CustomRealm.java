...
//        System.out.println(JWTUtil.verify(token, username));
        ...
        Login pwd=loginMapper.select_login(Long.valueOf(username));
        String password = pwd.getUser_pwd();
...
//        System.out.println("————权限认证————");
        ...
        //获得该用户角色
        String role = loginMapper.get_role(Long.valueOf(user_iphone));
        System.out.println(role);
        //每个角色拥有默认的权限
//        String rolePermission = userMapper.getRolePermission(user_iphone);
//        //每个用户可以设置新的权限
